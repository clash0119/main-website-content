...
import MemberShipForm from "./component/section/MemberShipForm";
import SingleMember from "./pages/SingleMember";
import BookingForm from "./component/section/BookingForm";
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="models" element={<MembersPage />} />
          ...
          <Route path="member-single/:modelCode" element={<SingleMember />} />
